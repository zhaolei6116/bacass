...
def merge_stat(raw_stat_sub, clean_stat_sub, qc_stat):
    ...
    with open(qc_stat, "w") as qc:
        head_line = ["Type","Number of base", "Number of Reads", "Reads N50", "Longest Reads(Q)", "Mean Reads Length", "Median Reads Length", "Mean Quality", "Reads >Q5", "Reads >Q10", "Reads >Q15"]
        attr_list = ["number_of_bases", 'number_of_reads', 'n50', 'longest_read_with_Q1', 'mean_read_length', 'median_read_length', 'mean_qual', 'ReadsQ5', 'ReadsQ10', 'ReadsQ15']
